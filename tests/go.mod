module github.com/roadrunner-server/circuit-breaker/v4/tests
...
require (
	github.com/roadrunner-server/config v0.0.0-20220109203440-8a8b5c3e03f5
...
replace (
	github.com/roadrunner-server/circuit-breaker/v4 => ../
)
...
require (
	...
	github.com/spiral/roadrunner-plugins/v2 v2.7.0-beta.1 // indirect
	github.com/spiral/roadrunner/v2 v2.7.0-beta.1 // indirect
